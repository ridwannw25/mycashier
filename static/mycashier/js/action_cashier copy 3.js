        ...
        success: function (resp) {
            ...
            for (i in resp['data']) {
                ...
                <div class="product-card">
                    <a href="#" onclick="checkOutProductId(` + resp['data'][i]['id'] + `, '` + resp['data'][i]['name'] + `')" class="product-link">
                        <img
                            src='`+dataArray[i]+`' />
                        ...
                        <span class="price">` + "Rp." + parseFloat(resp['data'][i]['selling_price']).toLocaleString('en-US') + `</span>
