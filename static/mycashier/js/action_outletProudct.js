$(function() {
    $('.view-data').click(function() {
        uni_modal("Transaction's invoice", "receipt_outletProduct?id=" + $(this).attr('data-id'))
    })
    $('.kwitansi-data').click(function() {
        uni_modal("Transaction's Kwitansi", "kwitansi?id=" + $(this).attr('data-id'))
    })
