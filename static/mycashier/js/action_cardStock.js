...
function postData(tendered_amountV2 = 0,change = 0) {
    ...
    formData.append('date_invoice', $("#date12").val());
    ...
    $.ajax({
        ...
        success: function (resp) {
            ...
            if (typeof resp == 'object' && resp.status == 'success') {
                uni_modal("Receipt", "receipt_outletProduct?id=" + resp.sale_id)
    ...
    if (prod_arr[id].stock == 0) {
        ...
        if (getIndex == -1) {
            ...
            <div class="col-md-4 col-sm-6 col-12 parentTable` + id + `" style="margin-top: 10px;">
                ...
                <p>
                    `+parseFloat(prod_arr[id].selling_price).toLocaleString('en-US')+`
                </p>
            </div>
            <div class="col-md-4 col-sm-6 col-12 parentTable` + id + `" style="margin-top: 10px;">
            `+dataInputCount+`
        ...
        `);
            ...
            console.log(prod_save[getIndex].qty +'||'+ prod_arr[id].stock);
